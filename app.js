...
const F = 'fill="#2B5347"';
const C = 'stroke="#DCE6E0" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" fill="none"';
...
const EX = [
  ...
  { id:'anklecircles', cat:'warmup', name:'Ankle circles', reps:'10 each direction, each foot', muscles:['calves'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M8 23 V39 H31 M11 39 V55 M29 39 V55" ${C}/><circle cx="23" cy="10" r="6" ${F}/><path d="M23 16 V34 M23 22 L12 29 M23 34 H39 L43 47 L52 48" ${S}/><path d="M37 45 A10 10 0 1 0 52 40 M52 40 L47 39 M52 40 L51 35" ${C}/></svg>` },
  ...
  { id:'rows', cat:'upper', name:'Seated rows (band)', reps:'10–12 reps', muscles:['back','arms'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M7 38 H30 M10 38 V55 M28 38 V55" ${C}/><circle cx="19" cy="10" r="6" ${F}/><path d="M19 16 V37 M19 37 L39 40 L46 54 M19 23 L30 29 L38 22 M19 23 L10 30" ${S}/><path d="M38 22 L53 17 M38 22 L53 27 M53 14 V31" ${C}/></svg>` },
  ...
  { id:'triceps', cat:'upper', name:'Seated tricep extensions', reps:'10 reps', muscles:['arms'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M11 40 H45 M14 40 V55 M42 40 V55" ${C}/><circle cx="30" cy="15" r="6" ${F}/><path d="M30 21 V40 M30 40 L20 53 M30 40 L40 53 M28 24 L20 13 L25 4 M32 24 L40 13 L35 4 M25 4 H35" ${S}/></svg>` },
  ...
  { id:'chestpress', cat:'upper', name:'Seated chest press', reps:'10–12 reps', muscles:['chest','arms'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M7 38 H29 M10 38 V55 M27 38 V55" ${C}/><circle cx="18" cy="10" r="6" ${F}/><path d="M18 16 V37 M18 37 L38 40 L45 54 M18 23 L43 23 M18 28 L43 28" ${S}/><path d="M47 18 V33 M42 18 V33" ${C}/></svg>` },
  { id:'frontraise', cat:'upper', name:'Seated front arm raises', reps:'10 reps', muscles:['shoulders'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M7 38 H29 M10 38 V55 M27 38 V55" ${C}/><circle cx="18" cy="10" r="6" ${F}/><path d="M18 16 V37 M18 37 L38 40 L45 54 M18 22 L44 17 M18 27 L44 22" ${S}/><circle cx="48" cy="16" r="3" fill="#DCE6E0"/><circle cx="48" cy="22" r="3" fill="#DCE6E0"/></svg>` },
  ...
  { id:'kneelifts', cat:'core', name:'Seated knee lifts', reps:'10 reps each side', muscles:['core'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M10 34 V55 M10 42 H34 M32 42 V55" ${C}/><circle cx="25" cy="10" r="6" ${F}/><path d="M25 16 V35 M25 22 L13 30 M25 35 L39 26 L46 17 M25 35 L29 42 L45 50" ${S}/></svg>` },
  { id:'twists', cat:'core', name:'Seated torso twists', reps:'10 reps each side', muscles:['core','back'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M13 38 H46 M16 38 V55 M43 38 V55" ${C}/><circle cx="30" cy="9" r="6" ${F}/><path d="M30 15 V37 M30 37 L20 53 M30 37 L40 53 M20 21 L39 28 M40 20 L21 28" ${S}/><path d="M15 14 Q30 4 45 14" ${C}/></svg>` },
  { id:'sidebend', cat:'core', name:'Seated side bends', reps:'8 reps each side', muscles:['core'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M14 40 H44 M17 40 V55 M41 40 V55" ${C}/><circle cx="36" cy="11" r="6" ${F}/><path d="M34 17 Q25 28 28 40 M28 40 L20 53 M28 40 L39 53 M32 20 Q22 10 13 7 M31 25 L43 30" ${S}/></svg>` },
  { id:'pelvictilt', cat:'core', name:'Seated pelvic tilts', reps:'10 reps, hold 3 seconds', timerSeconds:3, muscles:['core'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M11 20 V43 H38 M14 43 V56 M36 43 V56" ${C}/><circle cx="29" cy="10" r="6" ${F}/><path d="M28 16 Q21 27 27 39 M27 39 L42 43 L48 55 M26 22 L39 32" ${S}/><path d="M19 32 Q24 39 34 36 M19 32 L20 39 M19 32 L25 31" ${C}/></svg>` },
  ...
  { id:'spinaltwist', cat:'yoga', name:'Seated spinal twist', reps:'Hold 20 seconds each side', timerSeconds:20, muscles:['back','core'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M11 39 H45 M14 39 V55 M42 39 V55" ${C}/><circle cx="24" cy="10" r="6" ${F}/><path d="M27 16 Q32 26 30 39 M28 22 L43 32 M29 24 L17 31 M30 39 L20 53 M30 39 L42 53" ${S}/><path d="M15 15 Q29 5 43 15 M43 15 L38 11 M43 15 L38 19" ${C}/></svg>` },
  { id:'sidestretch', cat:'yoga', name:'Seated side stretch', reps:'Hold 20 seconds each side', timerSeconds:20, muscles:['core','back'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M12 40 H44 M15 40 V55 M41 40 V55" ${C}/><circle cx="36" cy="13" r="6" ${F}/><path d="M34 19 Q25 29 28 40 M28 40 L19 53 M28 40 L40 53 M32 21 Q23 12 18 4 M37 21 Q31 10 28 3" ${S}/></svg>` },
  ...
  { id:'figure4', cat:'yoga', name:'Seated figure-4 stretch', reps:'Hold 20–30 seconds each side', timerSeconds:30, muscles:['hips'],
    ...
    svg:`<svg viewBox="0 0 60 60"><path d="M8 39 H43 M11 39 V55 M40 39 V55" ${C}/><circle cx="25" cy="10" r="6" ${F}/><path d="M25 16 V38 M25 22 L14 31 M25 22 L37 31 M25 38 L42 40 L48 54 M25 38 L37 29 L48 36" ${S}/></svg>` },
